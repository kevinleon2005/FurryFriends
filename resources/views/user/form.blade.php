<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_nacimiento" class="form-control @error('fecha_nacimiento') is-invalid @enderror" value="{{ old('fecha_nacimiento', $user?->fecha_nacimiento) }}" id="fecha_nacimiento" placeholder="Fecha Nacimiento">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="tipo_documento" class="form-control @error('tipo_documento') is-invalid @enderror" value="{{ old('tipo_documento', $user?->tipo_documento) }}" id="tipo_documento" placeholder="Tipo Documento">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="numero_documento" class="form-control @error('numero_documento') is-invalid @enderror" value="{{ old('numero_documento', $user?->numero_documento) }}" id="numero_documento" placeholder="Numero Documento">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="foto_perfil" class="form-control @error('foto_perfil') is-invalid @enderror" value="{{ old('foto_perfil', $user?->foto_perfil) }}" id="foto_perfil" placeholder="Foto Perfil">
            {!! $errors->first('foto_perfil', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="experiencia" class="form-label">{{ __('Experiencia') }}</label>
            <input type="text" name="experiencia" class="form-control @error('experiencia') is-invalid @enderror" value="{{ old('experiencia', $user?->experiencia) }}" id="experiencia" placeholder="Experiencia">
            {!! $errors->first('experiencia', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="numero_mascotas" class="form-label">{{ __('Numero Mascotas') }}</label>
            <input type="text" name="numero_mascotas" class="form-control @error('numero_mascotas') is-invalid @enderror" value="{{ old('numero_mascotas', $user?->numero_mascotas) }}" id="numero_mascotas" placeholder="Numero Mascotas">
            {!! $errors->first('numero_mascotas', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
