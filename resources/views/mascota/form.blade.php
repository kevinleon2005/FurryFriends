<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="user_id" class="form-control @error('user_id') is-invalid @enderror" value="{{ old('user_id', $mascota?->user_id) }}" id="user_id" placeholder="User Id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="edad" class="form-control @error('edad') is-invalid @enderror" value="{{ old('edad', $mascota?->edad) }}" id="edad" placeholder="Edad">
        ...
        <div class="form-group mb-2 mb20">
            <label for="info_medica" class="form-label">{{ __('Info Medica') }}</label>
            <input type="text" name="info_medica" class="form-control @error('info_medica') is-invalid @enderror" value="{{ old('info_medica', $mascota?->info_medica) }}" id="info_medica" placeholder="Info Medica">
            {!! $errors->first('info_medica', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
